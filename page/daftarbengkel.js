...
class DaftarBengkel extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  handlePress = (item) => {
    ...
    this.props.navigation.navigate("DetailBengkel", {
      username,
      Address,
      HP,
      email,
  ...
  render() {
    return (
      <SafeAreaView>
        <Text style={styles.sila}>Daftar Lokasi</Text>
        <FlatList
          style={{ height: "100%" }}
